...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      // },
      {
        path: "options",
        loadChildren:
          "./modules/options/options.module#OptionsModule",
        canActivate: [CanActivateAdminGuard]
      },
      {
        path: "",
        loadChildren:
          "./modules/areas/areas.module#AreasModule",
        canActivate: [CanActivateAdminGuard]
      },
      {
      ...
      },
      {
        path: "activities",
        loadChildren:
          "./modules/activites/activites.module#ActivitiesModule",
        canActivate: [CanActivateAdminGuard]
      },
      {
        path: "occations",
        loadChildren:
          "./modules/occations/occation.module#OccationModule",
        canActivate: [CanActivateAdminGuard]
      },
      {
        path: "dayoffs",
        loadChildren:
          "./modules/dayoffs/dayoffs.module#DayOffsModule",
        canActivate: [CanActivateAdminGuard]
      },
      {
        path: "configurations",
